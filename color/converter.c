...
int main() {
    ...
    FILE *inputFile = fopen("/home/abhattar/Desktop/redis/redis/color/graph/graph_dblp_coauthorship_n317080.txt", "r");  // Replace with your input file path
    FILE *outputFile = fopen("/home/abhattar/Desktop/redis/redis/color/graph/edge_graph_dblp_coauthorship_n317080.txt", "w");  // Replace with your output file path
